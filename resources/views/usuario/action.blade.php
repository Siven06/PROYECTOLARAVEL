                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('password') is-invalid @enderror" id="password" name="password" value="" required>
                                        @error('password')
                                        <small class="text-danger">{{ ($message) }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select" name="activo" id="activo">
                                            <option value="1"{{old('activo', $registro->activo ?? '1' ? 'selected' : '')}}>Activo</option>
                                            <option value="0"{{old('activo', $registro->activo ?? '0' ? 'selected' : '')}}>Inactivo</option>
                                        </select>
                                        @error('activo')
                                        <small class="text-danger">{{ ($message) }}</small>
                                        @enderror
